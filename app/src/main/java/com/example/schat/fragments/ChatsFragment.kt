...
class ChatsFragment : Fragment() {
   ...
   private lateinit var mAdapter: FirebaseRecyclerAdapter<Chats, ChatViewHolder>
    ...
    private fun setupAdapter() {
        ...
        val options = FirebaseRecyclerOptions.Builder<Chats>()
                ...
                .setQuery(baseQuery, Chats::class.java)
                .build()
        // Instantiate Paging Adapter
        mAdapter = object : FirebaseRecyclerAdapter<Chats, ChatViewHolder>(options) {
