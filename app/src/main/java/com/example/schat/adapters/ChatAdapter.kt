...
import com.example.schat.modules.ChatEvent
import com.example.schat.modules.DateHeader
import com.example.schat.modules.Message
import com.example.schat.utils.formatAsTime
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            TEXT_MESSAGE_RECEIVED -> {
                MessageHolder(
                    inflate(R.layout.list_item_chat_received_message)
                )
            }
            TEXT_MESSAGE_SENT -> {
                MessageHolder(
